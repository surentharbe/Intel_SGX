...
static sgx_status_t SGX_CDECL sgx_TrustedFn(void* pms)
{
	ms_TrustedFn_t* ms = SGX_CAST(ms_TrustedFn_t*, pms);
	...
	CHECK_REF_POINTER(pms, sizeof(ms_TrustedFn_t));
...
SGX_EXTERNC const struct {
	...
	1,
	{
		{(void*)(uintptr_t)sgx_TrustedFn, 0},
	}
};
